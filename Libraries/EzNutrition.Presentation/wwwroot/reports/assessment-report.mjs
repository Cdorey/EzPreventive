...
export function createDefinition(data) {
    const content = [
        ...
        { text: `量表版本：${data.instrumentVersion}`, fontSize: 9, color: "#56636a", margin: [0, 0, 0, 16] },
        {
            table: { widths: ["*", "*"], body: [
        ...
        { text: data.interpretation, margin: [0, 0, 0, 14] },
    ...
    return {
        ...
        defaultStyle: { font: "ReportSans", fontSize: 10, lineHeight: 1.15, color: "#202d33" },
        styles: { section: { fontSize: 12, color: "#183b45", margin: [0, 14, 0, 8] } },
