...
namespace EzNutrition.Server.Controllers
{
    ...
    public class AdminController(RoleManager<IdentityRole> roleManager, ILogger<AdminController> logger, AuthManagerRepository authManagerRepository, ApplicationDbContext applicationDbContext) : ControllerBase
    {
        [HttpPost]
